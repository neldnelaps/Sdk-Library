...
open class NotificationAPI {
    ...
    /**
     ...
     - parameter notificationId: (path) Внутренний идентификатор оповещения (Id). 
    ...
    /**
     ...
     - parameter from: (query) Порядковый номер элемента, с которого должна начинаться выборка. (optional)
