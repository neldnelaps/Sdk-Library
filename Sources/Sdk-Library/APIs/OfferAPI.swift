...
open class OfferAPI {
     ...
     */
    open class func offerGetOffersWithRequestBuilder(filterMerchantId: Int? = nil, filterOfferState: CommunicationOfferState? = nil, filterFrom: Int? = nil, filterCount: Int? = nil, filterType: CommunicationOfferType? = nil, filterCategoryFilterType: OfferCategoryFilterType? = nil, filterCategoryLogicalNames: [String]? = nil) -> RequestBuilder<ResultModelOfPagedViewModelOfOfferModel> {
