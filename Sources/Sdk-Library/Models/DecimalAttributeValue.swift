...
public struct DecimalAttributeValue: Codable, JSONEncodable, Hashable {
    ...
    public init(value: Double? = nil, attributeId: Int? = nil, attributeLogicalName: String? = nil, attributeName: String? = nil, isRelated: Bool? = nil) {
        self.value = value
