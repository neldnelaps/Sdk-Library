//
// CalculatorFilterViewModel.swift
//
...
public struct CalculatorFilterViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(operation: FilterOperation? = nil, firstValue: Double? = nil, secondValue: Double? = nil, id: Int? = nil, name: String? = nil, isDeletedFilterType: Bool? = nil, processParameters: String? = nil, calculatorId: Int? = nil) {
