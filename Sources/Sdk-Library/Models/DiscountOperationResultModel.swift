//
// DiscountOperationResultModel.swift
//
...
/** Результат операции применения скидки. */
public struct DiscountOperationResultModel: Codable, JSONEncodable, Hashable {
    ...
    public init(transactionId: Int64? = nil, deviceLogicalId: String? = nil, operationId: String? = nil, code: ErrorCode? = nil, errorMessage: String? = nil, cashierMessage: String? = nil, chequeMessage: String? = nil, cheque: ChequeResponseModel? = nil, loyaltyPrograms: [LoyaltyProgramResponseModel]? = nil, identificationData: [ItemDataModel]? = nil, giftCertificates: [GiftCertificateModel]? = nil) {
