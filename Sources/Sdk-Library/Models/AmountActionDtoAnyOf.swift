...
public struct AmountActionDtoAnyOf: Codable, JSONEncodable, Hashable {
    ...
    public init(value: String? = nil, value2: String? = nil, value3: String? = nil, percent: Double? = nil, amountPerUnit: Double? = nil, amountPerUniqueSku: Double? = nil, pricePerUnit: Double? = nil, amount: Double? = nil, amountMeasure: Double? = nil, amountPerMeasure: Double? = nil, amountWeight: Double? = nil, amountPerWeight: Double? = nil, price: Double? = nil, attributeDiscount: AttributeDiscountDto? = nil, distributeToAll: Bool? = nil, discountType: String? = nil, calculationExclusionDiscountTypes: [CalculationExclusionDiscountType]? = nil) {
        self.value = value
        self.value2 = value2
        self.value3 = value3
