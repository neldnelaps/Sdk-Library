...
public struct GuidAttributeValue: Codable, JSONEncodable, Hashable {
    ...
    public init(value: UUID? = nil, attributeId: Int? = nil, attributeLogicalName: String? = nil, attributeName: String? = nil, isRelated: Bool? = nil) {
        self.value = value
