//
// BasePurchasesFilterViewModel.swift
//
...
public struct BasePurchasesFilterViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(startChequeTime: Date? = nil, lastChequeTime: Date? = nil, merchantIds: [Int]? = nil, loyaltyPrograms: [Int]? = nil, chequeNumber: String? = nil, count: Int? = nil, from: Int? = nil, cardNumber: String? = nil, personId: Int? = nil, personIdentifier: String? = nil, deviceIds: [Int]? = nil) {
