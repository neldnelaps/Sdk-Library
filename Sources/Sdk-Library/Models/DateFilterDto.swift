...
/** Фильтр \&quot;Дни\&quot;. */
public struct DateFilterDto: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, processParameters: String? = nil, _operator: ComparisonOperator? = nil, firstValueAsString: String? = nil, secondValueAsString: String? = nil, firstValue: Date? = nil, secondValue: Date? = nil) {
        self.name = name
