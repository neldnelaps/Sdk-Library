//
// SocialNetworksMessageViewModel.swift
//
...
public struct SocialNetworksMessageViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, body: String? = nil, creationDate: Date? = nil, changeDate: Date? = nil, gatewayId: Int? = nil, sentTime: Date? = nil, recipient: String? = nil, state: NotificationMessageState? = nil) {
        self.id = id
        self.body = body
