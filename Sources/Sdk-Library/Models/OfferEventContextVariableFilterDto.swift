//
// OfferEventContextVariableFilterDto.swift
//
...
public struct OfferEventContextVariableFilterDto: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, processParameters: String? = nil, _operator: ComparisonOperator? = nil, firstValue: Double? = nil, secondValue: Double? = nil, variable: OfferEventContextVariable? = nil) {
        self.name = name
