//
// FinishRegistrationResult.swift
//
...
public struct FinishRegistrationResult: Codable, JSONEncodable, Hashable {
    ...
    public init(tokenType: String? = nil, accessToken: String? = nil, refreshToken: String? = nil, expiresIn: Int? = nil, registrationCompleted: Bool? = nil, uncompletedActions: [UserActionModel]? = nil, authToken: String? = nil) {
