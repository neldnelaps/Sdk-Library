//
// UserAttributeViewModelAnyOf.swift
//
...
public struct UserAttributeViewModelAnyOf: Codable, JSONEncodable, Hashable {
    ...
    public init(type: CommonAttributeValueType? = nil, params: String? = nil, description: String? = nil, mergeMode: AttributesMergeMode? = nil, _required: Bool? = nil, isDeleted: Bool? = nil, isHidden: Bool? = nil, isDynamic: Bool? = nil, items: [Item]? = nil, hasMultipleValues: Bool? = nil, useTemplateEngine: Bool? = nil) {
        self.type = type
        self.params = params
