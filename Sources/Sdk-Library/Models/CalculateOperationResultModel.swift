//
// CalculateOperationResultModel.swift
//
...
/** Результат операции расчета прямой скидки и доступной суммы списания бонусов. */
public struct CalculateOperationResultModel: Codable, JSONEncodable, Hashable {
    ...
    public init(transactionId: Int64? = nil, deviceLogicalId: String? = nil, operationId: String? = nil, code: ErrorCode? = nil, errorMessage: String? = nil, cashierMessage: String? = nil, chequeMessage: String? = nil, cheque: ChequeResponseModel? = nil, loyaltyPrograms: [LoyaltyProgramResponseModel]? = nil, identificationData: [ItemDataModel]? = nil, availableAmount: Double? = nil, availableBonusAmount: Double? = nil, balance: Double? = nil, giftCertificates: [GiftCertificate]? = nil) {
