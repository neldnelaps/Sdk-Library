...
public struct PersonStatusViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, logicalName: String? = nil, description: String? = nil, statuses: [StatusViewModel]? = nil, currentStatus: StatusViewModel? = nil, counterUid: String? = nil, currentValue: Double? = nil, nextStatusValue: Double? = nil, fileExternalId: UUID? = nil, statusUpdateDate: Date? = nil) {
        self.name = name
