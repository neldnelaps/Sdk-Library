...
public struct BaseRegistrationResult: Codable, JSONEncodable, Hashable {
    ...
    public init(state: RegistrationState? = nil, errorMessage: String? = nil, authToken: String? = nil, authResult: AuthResultModel? = nil) {
        self.state = state
