...
public struct WeekDayFilterViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, name: String? = nil, isDeletedFilterType: Bool? = nil, processParameters: String? = nil, daysOfWeek: [DayOfWeek]? = nil) {
        self.id = id
        self.name = name
