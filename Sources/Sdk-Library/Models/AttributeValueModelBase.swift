...
public struct AttributeValueModelBase: Codable, JSONEncodable, Hashable {
    ...
    public init(attributeId: Int? = nil, attributeLogicalName: String? = nil, attributeName: String? = nil, isRelated: Bool? = nil) {
