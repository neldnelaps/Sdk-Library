...
/** Фильтр \&quot;Скрипт\&quot;. */
public struct ScriptFilterViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, name: String? = nil, isDeletedFilterType: Bool? = nil, processParameters: String? = nil, script: String? = nil) {
        self.id = id
        self.name = name
