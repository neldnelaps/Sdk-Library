//
// FavoriteGoodsCommonViewModel.swift
//
...
public struct FavoriteGoodsCommonViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, fromDate: Date? = nil, toDate: Date? = nil, defaultGoodsCount: Int? = nil, maxGoodsCount: Int? = nil, partnerId: Int? = nil) {
        self.id = id
