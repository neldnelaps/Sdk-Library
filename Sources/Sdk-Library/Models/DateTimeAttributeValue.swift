...
public struct DateTimeAttributeValue: Codable, JSONEncodable, Hashable {
    ...
    public init(value: Date? = nil, attributeId: Int? = nil, attributeLogicalName: String? = nil, attributeName: String? = nil, isRelated: Bool? = nil) {
        self.value = value
