//
// DeviceEmulationCreateChequePositionModel.swift
//
...
public struct DeviceEmulationCreateChequePositionModel: Codable, JSONEncodable, Hashable {
    ...
    public init(price: Double? = nil, quantity: Double? = nil, partnerDiscount: Double? = nil, partnerCashback: Double? = nil, goodID: Int? = nil) {
        self.price = price
