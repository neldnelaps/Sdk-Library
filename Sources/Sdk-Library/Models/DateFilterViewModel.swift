...
public struct DateFilterViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(operation: FilterOperation? = nil, firstValue: Date? = nil, secondValue: Date? = nil, id: Int? = nil, name: String? = nil, isDeletedFilterType: Bool? = nil, processParameters: String? = nil) {
