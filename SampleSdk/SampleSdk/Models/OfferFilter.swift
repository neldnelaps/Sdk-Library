...
public struct OfferFilter: Codable, JSONEncodable, Hashable {
    ...
    public init(merchantId: Int? = nil, offerState: OfferState? = nil, from: Int? = nil, count: Int? = nil, type: CommunicationOfferType? = nil, categoryFilterType: OfferCategoryFilterType? = nil, categoryLogicalNames: [String]? = nil) {
