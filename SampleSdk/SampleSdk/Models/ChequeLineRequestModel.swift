...
/** Информация о позиции в чеке в запросе на проведение операции. */
public struct ChequeLineRequestModel: Codable, JSONEncodable, Hashable {
    ...
    public init(position: Int? = nil, amount: Double? = nil, goodsId: String? = nil, barcode: String? = nil, quantity: Double? = nil, cashback: Double? = nil, discount: Double? = nil, appliedOffers: [OfferInfoModel]? = nil, name: String? = nil, price: Double? = nil, correction: Double? = nil, params: ParamsRequestModel? = nil) {
