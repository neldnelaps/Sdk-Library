...
public struct IntAttributeValue: Codable, JSONEncodable, Hashable {
    ...
    public init(value: Int? = nil, attributeId: Int? = nil, attributeLogicalName: String? = nil, attributeName: String? = nil, isRelated: Bool? = nil) {
        self.value = value
