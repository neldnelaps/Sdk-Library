...
/** Базовые данные о позиции в чеке. */
public struct BaseChequeLineRequestModel: Codable, JSONEncodable, Hashable {
    ...
    public init(position: Int? = nil, amount: Double? = nil, goodsId: String? = nil, barcode: String? = nil, quantity: Double? = nil, cashback: Double? = nil, discount: Double? = nil, appliedOffers: [OfferInfoModel]? = nil) {
