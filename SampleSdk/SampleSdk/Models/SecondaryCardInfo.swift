...
public struct SecondaryCardInfo: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, state: CardState? = nil, number: String? = nil, barCode: String? = nil, block: Bool? = nil, expiryDate: Date? = nil, cardCategory: CardCategoryInfo? = nil, cardOwnerInfo: UserInfoBase? = nil, accumulated: MoneyViewModel? = nil, paid: MoneyViewModel? = nil, accumulatedInfo: [MoneyViewModel]? = nil, paidInfo: [MoneyViewModel]? = nil, cardActionAccessInfo: CardActionAccessInfo? = nil, parentCardId: Int? = nil) {
        self.id = id
        self.state = state
        self.number = number
