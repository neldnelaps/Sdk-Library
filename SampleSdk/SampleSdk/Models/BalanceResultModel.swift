...
/** Результат получения баланса карты. */
public struct BalanceResultModel: Codable, JSONEncodable, Hashable {
    ...
    public init(transactionId: Int64? = nil, deviceLogicalId: String? = nil, operationId: String? = nil, code: ErrorCode? = nil, errorMessage: String? = nil, cashierMessage: String? = nil, chequeMessage: String? = nil, cheque: ChequeResponseModel? = nil, loyaltyPrograms: [LoyaltyProgramResponseModel]? = nil, identificationData: [ItemDataModel]? = nil, amount: Double? = nil, currency: String? = nil, description: String? = nil) {
