...
public struct GoodsCatalogLeafViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, id: Int? = nil, goodsCode: String? = nil, parentID: Int? = nil, isEnabled: Bool? = nil, checkState: CheckState? = nil, partnerId: Int? = nil, attributeValues: [GoodsAttributeValueViewModel]? = nil, loadDate: Date? = nil, barCodes: [String]? = nil, path: String? = nil) {
        self.name = name
        self.id = id
