...
public struct PersonalOfferModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, priority: Int? = nil, title: String? = nil, description: String? = nil, shortDescription: String? = nil, begin: Date? = nil, end: Date? = nil, rewardThumbnail: AnyCodable? = nil, rewardImageId: UUID? = nil, brandIds: [UUID]? = nil, brands: [BrandShortModel]? = nil, brandId: UUID? = nil, images: [ImageViewModel]? = nil, instructions: [String]? = nil, merchantsCount: Int? = nil, attribute: PersonalOfferAttributeModel? = nil, canSelectGoods: Bool? = nil) {
        self.id = id
