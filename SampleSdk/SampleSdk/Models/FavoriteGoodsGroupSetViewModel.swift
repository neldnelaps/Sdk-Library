//
// FavoriteGoodsGroupSetViewModel.swift
//
...
public struct FavoriteGoodsGroupSetViewModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, fromDate: Date? = nil, toDate: Date? = nil, defaultGoodsCount: Int? = nil, maxGoodsCount: Int? = nil, partnerId: Int? = nil, goodsGroupId: Int? = nil, goodsGroupName: String? = nil, personalOfferName: String? = nil, goods: [FavoriteGoodsPositionViewModel]? = nil) {
        self.id = id
